...
export const Banner = () => {
  ...
  return (
    <div className="relative w-full">
      <Image alt="Banner" src="/banner.png" width={1444} height={400} className="rounded-none w-screen h-screen" />
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10 ">
        <div className="text-center">
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className={clsx("text-[60px] font-bold z-12 text-blue-500/10 text-stroke pt-10 hover:text-white", fontHeading.className)}
            >
            ...
            <motion.p
                ...
                initial="hidden"
                animate="visible"
                className={clsx("text-lg m-0 text-white pb-10", myFont.className)}
            >
                {slogan}
            </motion.p>
        </div>

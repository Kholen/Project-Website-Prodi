  ...
  return (
    <>
      ...
      <div className="w-full p-4 bg-[#0a0950] text-white rounded-lg mb-10 text-center">
        <h1 className="text-2xl">Tambah Data Dosen Baru</h1>
      </div>
        ...
        <div className="w-full p-6 rounded-lg bg-white text-black space-y-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <Dropdown>
                <DropdownTrigger>
                  <Button variant="bordered" className="capitalize w-full justify-start">{selectedJabatanName}</Button>
                </DropdownTrigger>
                <DropdownMenu
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <Dropdown>
                <DropdownTrigger>
                  <Button variant="bordered" className="capitalize w-full justify-start">{selectedSkillName}</Button>
                </DropdownTrigger>
                <DropdownMenu

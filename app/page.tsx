...
export default function Home() {
  ...
  const defaultContent2 = "ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.";
  return (
    // <>
    <div className="container-fluid">
      <Tabs
            ...
            classNames={{
              tabList: "w-full p-2",
              tab: "w-full text-center px-3 py-5 font-medium",
            }}
          >
            {/* Tab 1: Tentang */}
            <Tab key="tentang" title="Tentang">
              <Card>
                ...
                <p className="mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid perferendis hic quisquam alias velit, porro deserunt reprehenderit ab facilis at inventore quo voluptatum veniam obcaecati! At, dolorum eos? Expedita, accusantium!</p>
                </div>
                <div className="w-full p-4 flex flex-col md:flex-row items-center gap-6 shadow-md rounded-lg mt-2            ">
                <Image
            ...
            <Tab key="prospek-kerja" title="Prospek Kerja">
                <Card className="mt-4">
                  ...
                  <CardBody className="flex flex-row gap-4"> {/* Menambahkan 'gap-4' untuk memberi jarak antar kolom */}
                    
                    {/* Bagian Kiri: Accordion */}
                    <div className="w-5/10 justify-center pl-2 content-center"> {/* Kolom ini mengambil 2/3 lebar */}
                       <h1 className="text-4xl font-bold text-center">Prospek kerja</h1>
                       <p className="mt-4 text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus dicta dolorem, voluptates at consequuntur nam asperiores ex architecto, illum minus placeat voluptatibus voluptatum ab delectus autem dolor non quasi incidunt.</p>
                       <p className="mt-4 text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus dicta dolorem, voluptates at consequuntur nam asperiores ex architecto, illum minus placeat voluptatibus voluptatum ab delectus autem dolor non quasi incidunt.</p>
                    </div>

                    {/* Bagian Kanan: Judul H1 */}
                    <div className="w-5/10 max-h-[400px] overflow-hidden">
                     <Accordion>
                        ...
                        <AccordionItem key="4" aria-label="Accordion 4" className="overflow-hidden" title="Desainer UI/UX(User Interface/User Experience Designer)">
                          {defaultContent}
                        </AccordionItem>
                        <AccordionItem key="5" aria-label="Accordion 5" className="overflow-hidden" title="Pengembang Perangkat Lunak(Software Developer)ilai-Nilai Perusahaan">
                          {defaultContent}
                        </AccordionItem>
                        <AccordionItem key="6" aria-label="Accordion 6" className="overflow-hidden" title="Analis Data (Data Analyst) dan Ilmuwan Data (Data Scientist)">
                          {defaultContent}
                        </AccordionItem>
                      </Accordion>
                    </div>
              ...
              <Card className="mt-4">
                <CardBody>
                  ...
                  <div className="flex w-full flex-col pt-4">
                    <Tabs aria-label="Options" className="w-full max-w-8xl mx-auto line-bawah" classNames={{ // Menghapus latar belakang abu-abu dan menambahkan garis batas bawah
                      ...
                      <Tab key="photos" title="Deskripsi Program">
                        <Card>
                          <CardBody>
                            ...
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit vero facilis voluptates ut alias, hic repellendus assumenda quis quasi, sequi, eum nostrum veritatis! Aspernatur excepturi tempore esse labore quaerat necessitatibus.
                          </CardBody>
                        </Card>
                      </Tab>
                      <Tab key="videos" title="Keunggulan Prodi">
                        <Card>
                          <CardBody>
                            ...
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos, odio nostrum officiis excepturi doloribus iure unde atque molestias ratione, officia delectus non esse tempore expedita repellat. Sunt consequuntur earum dolore.
                          </CardBody>
                        </Card>
                      </Tab>
                    </Tabs>

                    ...
                    <Tab key="photos" title="Deskripsi Program">
                      <Card>
                        <CardBody>
                          ...
                          dolor sit amet consectetur adipisicing elit. Fugit vero facilis voluptates ut alias, hic repellendus assumenda quis quasi,
                          sequi, eum nostrum veritatis! Aspernatur excepturi tempore esse labore quaerat necessitatibus.
                        </CardBody>
                      </Card>
                    </Tab>
      ...
      <div id="Visi-Misi" className="w-screen relative left-1/2 -translate-x-1/2 h-200 mainColor">
        ...
        <div className="w-screen relative left-1/2 -translate-x-1/2 h-200 mainColor ">
          <div className="container mx-auto px-6 h-full flex justify-between items-center">
            <div className="">
              <div className="mb-5">
                  <div className="text-white font-bold text-2xl text-center rounded-lg bg-blue-800 w-30 p-2 my-2 hover justify-self-center">
                    Misi
                  </div>

                <div className="bg-white rounded-lg w-auto p-5 justify-content">
                  Menjadikan Program studi Sistem Informasi STT Indonesia Tanjungpinang berkualitas dan unggul pada tahun 2025 dalam pengajaran, penelitian, dan pengabdian masyarakat bidang Big Data dan Data Science di Kepulauan Riau.
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg w-auto">
                <ul className="p-10 justify-content list-disc">
            ...
            <div className="bg-gray-300 rounded-2xl w-80 h-75 pr-5 ml-25">
